...
<div class="divbi">
     <span style="color: white;background-color: green; font-size: 1.8em; font-weight: bold; padding: 2px 4px; border: 1px solid green; border-radius: 5px;">Addmit Student List</span>
     <!-- Don't place <button> inside <a>, use only one. Here, use <a> styled like a button -->
     <form method="GET" action="{{ route('studentpayments.index') }}" >
     ...
     <a class="buttonbi" href="{{ url('studentpayments/create') }}">
        <span>Admission</span>
     </a>
</div>
        ...
        <td>
            <div class="divc">
               <!-- <a href='{{url("studentpayments/$studentpayment->id/edit")}}'> <button class="buttonc"><i class='bx bx-edit'></i></button></a> -->
                <a href='{{url("studentpayments/$studentpayment->id")}}'><button class="buttonc"><i class="bi bi-printer-fill"></i></button></a>
