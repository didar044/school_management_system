...
<div class="divbi">   
<a class="buttonbi" href="{{ url('books') }}"><span>Back To List</span></a> 
</div>
    ...
    <form action="{{ url('books') }}" method="post"  enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="number" name="year_published" min="1000" max="9999">
            </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="number" name="copies_available" min="0" required>
            </div>
        </div>
